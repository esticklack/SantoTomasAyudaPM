...
public class MqttActivity_Nacho extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mqtt_nacho);
        ...
        client = MqttClient.builder()
                .useMqttVersion3()
                .identifier(clientId)
                .serverHost("83050946a2b340ffa9b3939bfebb48d8.s2.eu.hivemq.cloud")
                .serverPort(8883)
        ...
        client.connectWith()
                .simpleAuth()
                .username("nacho_ofc")
                .password("nachonebulous".getBytes())
                .applySimpleAuth()
                .send()
